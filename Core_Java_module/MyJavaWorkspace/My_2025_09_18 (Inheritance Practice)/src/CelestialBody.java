...
class TestCelestialBody {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
	     ...
	     cb1.display();
	     CelestialBody cb2 = new CelestialBody("GenericBody", 0.000003, 9.8, "Nitrogen-Oxygen"); // Earth ~3e-6 Solar Mass
	     cb2.display();

	     Planet p1 = new Planet();
	     p1.display();
	     Planet p2 = new Planet("Earth", 0.000003, 9.8, "Nitrogen-Oxygen", "Sun", true);
	     p2.display();

	     Star s1 = new Star();
	     s1.display();
	     Star s2 = new Star("Sun", 1.0, 274.0, "Plasma", 100, 50); // Sun = 1 Solar Mass
	     s2.display();

	     Asteriod a1 = new Asteriod();
	     a1.display();
	     Asteriod a2 = new Asteriod("Ceres", 4.7e-10, 0.27, "None", "Asteroid Belt", "Sun"); // Ceres ~4.7e-10 Solar Mass
	     a2.display();
	} //main ends here
