...
class TestVRHeadset {
	...
	public static void main(String[] args) {
		...
		VRHeadset vr1 = new VRHeadset();
        vr1.display();
        VRHeadset vr2 = new VRHeadset("VisionPro", "Apple", 2160);
        vr2.display();

        GamingVR gvr1 = new GamingVR();
        gvr1.display();
        GamingVR gvr2 = new GamingVR("Oculus Quest", "Meta", 2880, 120);
        gvr2.display();

        TrainingVR tvr1 = new TrainingVR();
        tvr1.display();
        TrainingVR tvr2 = new TrainingVR("HTC Vive Pro", "HTC", 2440, 9, 7);
        tvr2.display();
	} //main ends here
